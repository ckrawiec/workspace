...
truth_form = home_dir+'DES/data/balrog_sva1_tab{}_TRUTH_fluxes.fits'
sim_form = home_dir+'DES/data/balrog_sva1_auto_tab{}_SIM.fits'
...
def zpcorrect():
    ...
    out_form = home_dir+'DES/data/balrog_sva1_tab{}_TRUTH_zp_corr_fluxes.fits'
