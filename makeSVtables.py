...
sv_no_cosmos = np.loadtxt('/home/ckrawiec/DES/magnification/lbgselect/gold_no_cosmos_indices.txt')
sv_cosmos = np.loadtxt('/home/ckrawiec/DES/magnification/lbgselect/gold_cosmos_indices.txt')
cosmos_ind = np.loadtxt('/home/ckrawiec/DES/magnification/lbgselect/cosmos15_indices.txt')
